...
export const isIosDevice = () => typeof window !== 'undefined' && /iPhone|iPad|iPod/i.test(navigator.userAgent);

export const isMobileDevice = () =>
  typeof window !== 'undefined' && (isIosDevice() || /Android|Opera Mini/i.test(navigator.userAgent));
